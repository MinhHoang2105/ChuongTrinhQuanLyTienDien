...
public class ClientView extends javax.swing.JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        jButton_huyTimKiemHoaDon = new javax.swing.JButton();
        ...
        jTable_thongTinKhachHang.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã số công tơ", "Họ tên chủ nhà", "Số điện thoại", "Địa chỉ", "Phòng"
            }
        ));
        ...
        jPanel_thongTinKhachHang.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 130, 170, 20));
        ...
        jPanel_thongTinKhachHang.add(jTextField_maSoCongTo, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 120, 190, 40));

        jLabel6.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 153, 255));
        jLabel6.setText("Họ tên chủ nhà:");
        jPanel_thongTinKhachHang.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 190, 170, 20));
        ...
        jPanel_thongTinKhachHang.add(jTextField_hoTenChuNha, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 180, 190, 40));

        jLabel7.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 153, 255));
        jLabel7.setText("Số điện thoại:");
        jPanel_thongTinKhachHang.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 250, 170, 20));
        ...
        jPanel_thongTinKhachHang.add(jTextField_soDienThoai, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 240, 190, 40));

        jLabel8.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 153, 255));
        jLabel8.setText("Địa chỉ:");
        jPanel_thongTinKhachHang.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 310, 170, 20));
        ...
        jPanel_thongTinKhachHang.add(jTextField_diaChi, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 300, 190, 40));
        ...
        jPanel_thongTinKhachHang.add(jTextField_phong, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 360, 190, 40));
        ...
        jPanel_thongTinKhachHang.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 370, 170, 20));
        ...
        jButton_huyTimKiemHoaDon.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jButton_huyTimKiemHoaDon.setForeground(new java.awt.Color(255, 51, 51));
        jButton_huyTimKiemHoaDon.setText("X");
        jButton_huyTimKiemHoaDon.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton_huyTimKiemHoaDonActionPerformed(evt);
            }
        });
        jPanel_hoaDon.add(jButton_huyTimKiemHoaDon, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 520, 40, -1));
        ...
        jButton_timKiemHoaDon.setForeground(new java.awt.Color(51, 153, 255));
        jButton_timKiemHoaDon.setText("Tìm Kiếm");
        jButton_timKiemHoaDon.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton_timKiemHoaDonActionPerformed(evt);
            }
        });
        jPanel_hoaDon.add(jButton_timKiemHoaDon, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 520, 120, -1));
...
//1050-615
    ...
    public HoaDonModel getInfoHoaDon() {
        ...
        if (chiSoCu > chiSoMoi) {
            JOptionPane.showMessageDialog(this, "Mời nhập chỉ số mới lớn hơn chỉ số cũ!");
            return null;
        }
    ...
    private void jButton_huyTimKiemHoaDonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_huyTimKiemHoaDonActionPerformed
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_jButton_huyTimKiemHoaDonActionPerformed
...
//                .getResource("/img/icon_huy.jpg"))));
    ...
    private javax.swing.JButton jButton_huyTimKiemHoaDon;

...
public class DangNhapView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox_phanQuenDangNhap = new javax.swing.JComboBox<>();
        ...
        jComboBox_phanQuenDangNhap.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jComboBox_phanQuenDangNhap.setForeground(new java.awt.Color(51, 153, 255));
        jComboBox_phanQuenDangNhap.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Admin", "Client" }));
        getContentPane().add(jComboBox_phanQuenDangNhap, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 70, -1, -1));
    ...
    private void jButton_dangNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_dangNhapActionPerformed
        ...
        if (jComboBox_phanQuenDangNhap.getSelectedItem().toString().equals("Admin") && taiKhoan.equals("admin") && matKhau.equals("2105")) {
            Server server = new Server();
            server.show();
        }else if (jComboBox_phanQuenDangNhap.getSelectedItem().toString().equals("Client") && nguoiDungDAO.checkCredentials(taiKhoan, matKhau) == true) {
            System.out.println("Đăng nhập thành công");
            ClientView cv = new ClientView(taiKhoan);
            cv.show();
    ...
    private javax.swing.JComboBox<String> jComboBox_phanQuenDangNhap;
